<?php
  ...
  */
  ...
  class curl_class extends curl_config
  {
    ...
    public function getAuthAPI()
    {
      ...
      return $this->postAuthentication("<Web_Service_Authentication>");
    }
    ...
    // Post Data
    public function postDataAPI($jsonString, $accessToken)
    {
      // Return data from API
      return $this->postData($jsonString, $accessToken, "<Web_Service_Post>");
    }
